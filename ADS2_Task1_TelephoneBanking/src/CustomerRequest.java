...
public class CustomerRequest {
    public int request; //The indication of which request the customer has
    ...
    public boolean checkID(String id)
    {
        ...
        System.out.println("ERROR: Please input an ID starting with 2 uppercase letters followed by 5 numbers!\n");
        return false;
    }
